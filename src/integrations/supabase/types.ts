  ...
  public: {
    ...
    Views: {
      ...
      v_installments: {
        Row: {
          ...
          receivable_id: string | null;
          receivable_status: Database["public"]["Enums"]["receivable_status"] | null;
    ...
    Functions: {
      ...
      create_agreement_with_schedule: {
        Args: {
          _agreement_date: string | null;
          _case_id: string | null;
          _client_id: string;
          _cost_reimbursement: number;
          _description: string | null;
          _expected_client_amount: number;
          _expected_firm_amount: number;
          _fee_fixed_amount: number | null;
          _fee_percent: number | null;
          _flow: string;
          _gross_amount: number;
          _installments: Json;
          _is_estimated: boolean;
          _manual_override_reason: string | null;
          _notes: string | null;
          _status: string;
      ...
      cancel_receivable: { Args: { _reason: string; _receivable_id: string }; Returns: undefined };
      cancel_transfer: { Args: { _reason: string; _transfer_id: string }; Returns: undefined };
      ...
      reverse_receipt: { Args: { _reason: string; _receipt_id: string }; Returns: undefined };
    };
    Enums: {
      app_role:
        "admin" | "financeiro" | "advogado" | "consulta" | "socio_gestor" | "lancador" | "cobranca";
      ...
      receivable_status:
        ...
        | "encerrado"
        | "cancelado";
      receivable_type: "acordo" | "sentenca" | "execucao" | "honorarios" | "outro";
